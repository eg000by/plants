...
const plantData = [
  ...
  {
    name: "Фикус Ирен",
    description: "Ирен — интересный сорт фикуса Бенджамина. Он отличается декоративным внешним видом. Но при этом требует засобой тщательного ухода.",
    price: `1300`,
    image: "content/plantPhotos/ficus2.png",
    characteristics: {
      height: "Ширина 12 см x Высота 15 см",
      wateringMore: `Поливайте его 2 раза в неделю. Всегда проверяйте свои растения перед поливом, верхний слой почвы должен быть сухим на ощупь. Для суккулентов дайте смеси для заливки полностью высохнуть, прежде чем снова поливать.`,
      beginnerMore: `Растение комфортно при теплой комнатной температуре от 15 до 24 градусов Цельсия. Избегайте резких перепадов температуры.Подкармливайте растение удобрениями весной и летом, используя универсальные жидкие удобрения для комнатных растений.Пересаживайте Фикус Ирен каждые 2-3 года в более большой горшок с новой питательной почвой.`,
      lightMore: `Разместите растение в помещении, где есть яркое, но рассеянное освещение. Избегайте прямых солнечных лучей, которые могут привести к ожогам на листьях. Размещение рядом с окном с восточной или западной стороны обычно является хорошим выбором.`,
    },
