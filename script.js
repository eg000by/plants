...
const plantData = [
  {
    ...
    price: `500`,
    image: "content/plantPhotos/plant1",
    characteristics: {
  ...
  },
  {
    ...
    price: `700`,
    image: "content/plantPhotos/monstera1",
    characteristics: {
  ...
  },
  {
    ...
    price: `1300`,
    image: "content/plantPhotos/ficus1",
    characteristics: {
  ...
  },
  {
    ...
    price: `600`,
    image: "content/plantPhotos/epip1",
    characteristics: {
      height: "Ширина 12 см x Высота 20 см",
...
function openModal(card) {
  ...
  if (selectedPlant) {
    ...
    // Создаем элемент <picture> и добавляем его в левую часть модального окна
    const picture = document.createElement("picture");


    // Создаем элемент <source> для формата webp
    const sourceWebp = document.createElement("source");
    sourceWebp.setAttribute("srcset", `${imgSrc}.webp`);
    sourceWebp.setAttribute("type", "image/webp");

    // Создаем элемент <img> и устанавливаем атрибуты
    const img = document.createElement("img");
    img.setAttribute("src", `${imgSrc}.png`);
    img.setAttribute("alt", "Растение");

    // Добавляем элементы <source> и <img> внутрь элемента <picture>
    picture.appendChild(sourceWebp);
    picture.appendChild(img);

    // Добавляем элемент <picture> в левую часть модального окна
    leftSection.appendChild(picture);
